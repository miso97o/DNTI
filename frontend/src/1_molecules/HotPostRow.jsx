...
export default function HotPostRow({
  ...
  return (
    ...
    >
      <div className="flex flex-row h-8 w-full items-center p-5  border-b-slate-200 border-b-2 box-border bg-purple-100 hover:bg-purple-200">
        <div className="flex flex-row w-full items-stretch justify-between">
          ...
          <div className="grid grid-cols-11 justify-end items-center w-5/12 text-sm">
            ...
            <p className="col-span-2 ml-1 flex justify-end">{date.replaceAll("-", "/")}</p>
          </div>
        </div>
      </div>
    </Link>
